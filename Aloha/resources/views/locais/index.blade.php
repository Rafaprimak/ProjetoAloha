    ...
    <div class="row">
        ...
        <div class="col-md-12 mb-4">
            <div class="card">
                <div class="card-body text-center">
                    <h2 class="card-title" style="color: #7c0c6e; font-size: 1.5rem;">
                        <a href="{{ url('locais/1') }}" class="text-decoration-none" style="color: #7c0c6e;">
                            Brasil
                        </a>
                    </h2>
                    <p class="card-text">Clique para conhecer os principais locais</p>
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            <img src="{{ asset('img/gramadoindex.jpg') }}" class="img-fluid img-thumbnail" alt="Brasil" style="border-radius: 15px;">
                        </div>
                        <div class="col-md-3 mb-3">
                            <img src="{{ asset('img/cachoeiraindex.jpg') }}" class="img-fluid img-thumbnail" alt="Brasil" style="border-radius: 15px;">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-12 mb-4">
            <div class="card">
                <div class="card-body text-center">
                    <h2 class="card-title" style="color: #7c0c6e; font-size: 1.5rem;">
                        <a href="{{ url('locais/2') }}" class="text-decoration-none" style="color: #7c0c6e;">
                            Paraguai
                        </a>
                    </h2>
                    <p class="card-text">Clique para conhecer os principais locais</p>
                    <div class="row">
                        <div class="col-md-3 mb-3">
                            <img src="{{ asset('img/paraguai1.jpg') }}" class="img-fluid img-thumbnail" alt="Paraguai" style="border-radius: 15px;">
                        </div>
                        <div class="col-md-3 mb-3">
                            <img src="{{ asset('img/paraguai2.jpg') }}" class="img-fluid img-thumbnail" alt="Paraguai" style="border-radius: 15px;">
                        </div>
                        <div class="col-md-3 mb-3">
                            <img src="{{ asset('img/paraguai3.jpg') }}" class="img-fluid img-thumbnail" alt="Paraguai" style="border-radius: 15px;">
                        </div>
                        <div class="col-md-3 mb-3">
                            <img src="{{ asset('img/paraguai4.jpg') }}" class="img-fluid img-thumbnail" alt="Paraguai" style="border-radius: 15px;">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-12 mb-4">
            <div class="card">
                <div class="card-body text-center">
                    <h2 class="card-title" style="color: #7c0c6e; font-size: 1.5rem;">
                        <a href="{{ url('locais/3') }}" class="text-decoration-none" style="color: #7c0c6e;">
                            Argentina
                        </a>
                    </h2>
                    <p class="card-text">Clique para conhecer os principais locais</p>
                    <div class="row">
                        <div class="col-md-3 mb-3">
                            <img src="{{ asset('img/argentina1.jpg') }}" class="img-fluid img-thumbnail" alt="Argentina" style="border-radius: 15px;">
                        </div>
                        <div class="col-md-3 mb-3">
                            <img src="{{ asset('img/argentina2.jpg') }}" class="img-fluid img-thumbnail" alt="Argentina" style="border-radius: 15px;">
                        </div>
                        <div class="col-md-3 mb-3">
                            <img src="{{ asset('img/argentina3.jpg') }}" class="img-fluid img-thumbnail" alt="Argentina" style="border-radius: 15px;">
                        </div>
                        <div class="col-md-3 mb-3">
                            <img src="{{ asset('img/argentina4.jpg') }}" class="img-fluid img-thumbnail" alt="Argentina" style="border-radius: 15px;">
                        </div>
                    </div>
                </div>
            </div>
